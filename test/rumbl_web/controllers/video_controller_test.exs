defmodule RumblWeb.VideoControllerTest do
  ...
  describe "with a logged-in user" do
    ...
    @create_attrs %{url: "http://example.com", title: "vid", description: "a vid"}
  ...
  test "authorizes actions against access by the other users", %{conn: conn} do
    owner = user_fixture(username: "owner")
    video = video_fixture(owner, @create_attrs)
    non_owner = user_fixture(username: "non-owner")
